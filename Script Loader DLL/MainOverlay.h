...
struct ExampleAppConsole
{
	...
	void Draw(const char* title, bool* p_open)
	{
		...
		ImGui::TextWrapped("Note from moneyl: This console currently doesn't do much, however, it will end up being hooked into the lua interpreter, allowing you to call the same functions scripts will eventually be able to use from here.");
