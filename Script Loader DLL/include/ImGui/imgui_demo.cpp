...
void ImGui::ShowDemoWindow(bool* p_open)
{
	...
	ImGui::TextWrapped("This is just the demo window that comes with the gui library I'm using. You can open some of the tabs to see what it's capable of, or just close it.");
