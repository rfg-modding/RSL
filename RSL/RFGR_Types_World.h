...
{
	ANIMATION_STATE_NONE = 0xFFFFFFFF,
	ANIMATION_INDEX_INVALID = 0x0,
	ANIMATION_STATE_STAND = 0x1,
	ANIMATION_STATE_STAND_DRAW = 0x2,
	ANIMATION_STATE_SITTING = 0x3,
	ANIMATION_STATE_SLEEP = 0x4,
	ANIMATION_STATE_RECOVER = 0x5,
	ANIMATION_STATE_ANGRY_STAND = 0x6,
	ANIMATION_STATE_SITTING_HARMONICA = 0x7,
	ANIMATION_STATE_SITTING_TALKING = 0x8,
	ANIMATION_STATE_RADIO_USE = 0x9,
	ANIMATION_STATE_COWER_STAND = 0xA,
	ANIMATION_STATE_COWER_CROUCH = 0xB,
	ANIMATION_STATE_CROUCH_COWER_1 = 0xC,
	ANIMATION_STATE_CROUCH_COWER_2 = 0xD,
	ANIMATION_STATE_STAND_COWER_INCOMING_IDLE = 0xE,
	ANIMATION_STATE_FETAL = 0xF,
	ANIMATION_STATE_RUN_PANICKED = 0x10,
	ANIMATION_STATE_GUARD_AIM = 0x11,
	ANIMATION_STATE_GUARD_YELL = 0x12,
	ANIMATION_STATE_REACTION_CAR_WRECK = 0x13,
	ANIMATION_STATE_REACTION_DEAD_BODY = 0x14,
	ANIMATION_STATE_REACTION_INSPECT_BODY = 0x15,
	ANIMATION_STATE_REACTION_MELEE_STAND_AND_WATCH = 0x16,
	ANIMATION_STATE_REACTION_MELEE_STAND_AND_CHEER = 0x17,
	ANIMATION_STATE_WALK = 0x18,
	ANIMATION_STATE_WALK_YELLOW_ALERT = 0x19,
	ANIMATION_STATE_SEARCH_WALK = 0x1A,
	ANIMATION_STATE_RUN = 0x1B,
	ANIMATION_STATE_JOG = 0x1C,
	ANIMATION_STATE_SPRINT = 0x1D,
	ANIMATION_STATE_RUN_ON_FIRE = 0x1E,
	ANIMATION_STATE_RUN_COWERING = 0x1F,
	ANIMATION_STATE_COVER_STAND_LEFT = 0x20,
	ANIMATION_STATE_COVER_STAND_LEFT_LEAN = 0x21,
	ANIMATION_STATE_COVER_STAND_LEFT_WALK = 0x22,
	ANIMATION_STATE_COVER_STAND_LEFT_BLIND_IDLE = 0x23,
	ANIMATION_STATE_COVER_STAND_RIGHT = 0x24,
	ANIMATION_STATE_COVER_STAND_RIGHT_LEAN = 0x25,
	ANIMATION_STATE_COVER_STAND_RIGHT_WALK = 0x26,
	ANIMATION_STATE_COVER_STAND_RIGHT_BLIND_IDLE = 0x27,
	ANIMATION_STATE_COVER_STAND_RIGHT_AIM = 0x28,
	ANIMATION_STATE_COVER_STAND_RIGHT_AIM_WALK = 0x29,
	ANIMATION_STATE_COVER_STAND_RIGHT_AIM_WALKBACK = 0x2A,
	ANIMATION_STATE_COVER_STAND_LEFT_AIM = 0x2B,
	ANIMATION_STATE_COVER_STAND_LEFT_AIM_WALK = 0x2C,
	ANIMATION_STATE_COVER_STAND_LEFT_AIM_WALKBACK = 0x2D,
	ANIMATION_STATE_COVER_CROUCH_LEFT = 0x2E,
	ANIMATION_STATE_COVER_CROUCH_LEFT_AIM = 0x2F,
	ANIMATION_STATE_COVER_CROUCH_LEFT_LEAN = 0x30,
	ANIMATION_STATE_COVER_CROUCH_LEFT_WALK = 0x31,
	ANIMATION_STATE_COVER_CROUCH_LEFT_BLIND_IDLE = 0x32,
	ANIMATION_STATE_COVER_CROUCH_LEFT_LEANUP_IDLE = 0x33,
	ANIMATION_STATE_COVER_CROUCH_LEFT_DIVE = 0x34,
	ANIMATION_STATE_COVER_CROUCH_LEFT_AIM_WALK = 0x35,
	ANIMATION_STATE_COVER_CROUCH_LEFT_AIM_WALKBACK = 0x36,
	ANIMATION_STATE_COVER_CROUCH_RIGHT = 0x37,
	ANIMATION_STATE_COVER_CROUCH_RIGHT_AIM = 0x38,
	ANIMATION_STATE_COVER_CROUCH_RIGHT_LEAN = 0x39,
	ANIMATION_STATE_COVER_CROUCH_RIGHT_WALK = 0x3A,
	ANIMATION_STATE_COVER_CROUCH_RIGHT_BLIND_IDLE = 0x3B,
	ANIMATION_STATE_COVER_CROUCH_RIGHT_LEANUP_IDLE = 0x3C,
	ANIMATION_STATE_COVER_CROUCH_RIGHT_DIVE = 0x3D,
	ANIMATION_STATE_COVER_CROUCH_RIGHT_AIM_WALK = 0x3E,
	ANIMATION_STATE_COVER_CROUCH_RIGHT_AIM_WALKBACK = 0x3F,
	ANIMATION_STATE_COVER_CROUCH_READY_LEFT = 0x40,
	ANIMATION_STATE_COVER_CROUCH_READY_LEFT_WALK = 0x41,
	ANIMATION_STATE_COVER_CROUCH_READY_RIGHT = 0x42,
	ANIMATION_STATE_COVER_CROUCH_READY_RIGHT_WALK = 0x43,
	ANIMATION_STATE_COVER_CROUCH_BLIND_LEFT = 0x44,
	ANIMATION_STATE_COVER_CROUCH_BLIND_LEFT_WALK = 0x45,
	ANIMATION_STATE_COVER_CROUCH_BLIND_RIGHT = 0x46,
	ANIMATION_STATE_COVER_CROUCH_BLIND_RIGHT_WALK = 0x47,
	ANIMATION_STATE_STAND_READY = 0x48,
	ANIMATION_STATE_STAND_READY_LEFT = 0x49,
	ANIMATION_STATE_STAND_READY_RIGHT = 0x4A,
	ANIMATION_STATE_STAND_TITLE_SCREEN = 0x4B,
	ANIMATION_STATE_WALK_LEFT = 0x4C,
	ANIMATION_STATE_WALK_RIGHT = 0x4D,
	ANIMATION_STATE_WALK_BACK = 0x4E,
	ANIMATION_STATE_WALK_READY = 0x4F,
	ANIMATION_STATE_WALK_READY_LEFT = 0x50,
	ANIMATION_STATE_WALK_READY_RIGHT = 0x51,
	ANIMATION_STATE_WALK_READY_BACK = 0x52,
	ANIMATION_STATE_WALK_READY_BACKPEDAL = 0x53,
	ANIMATION_STATE_RUN_LEFT = 0x54,
	ANIMATION_STATE_RUN_RIGHT = 0x55,
	ANIMATION_STATE_RUN_BACK = 0x56,
	ANIMATION_STATE_RUN_BACKPEDAL = 0x57,
	ANIMATION_STATE_RUN_READY = 0x58,
	ANIMATION_STATE_RUN_READY_LEFT = 0x59,
	ANIMATION_STATE_RUN_READY_RIGHT = 0x5A,
	ANIMATION_STATE_RUN_READY_BACK = 0x5B,
	ANIMATION_STATE_RUN_READY_BACKPEDAL = 0x5C,
	ANIMATION_STATE_STAND_AIM = 0x5D,
	ANIMATION_STATE_RUN_AIM = 0x5E,
	ANIMATION_STATE_RUN_AIM_LEFT = 0x5F,
	ANIMATION_STATE_RUN_AIM_RIGHT = 0x60,
	ANIMATION_STATE_RUN_AIM_BACK = 0x61,
	ANIMATION_STATE_STAND_NO_AMMO = 0x62,
	ANIMATION_STATE_RUN_NO_AMMO = 0x63,
	ANIMATION_STATE_CROUCH_NO_AMMO = 0x64,
	ANIMATION_STATE_CROUCH_WALK_NO_AMMO = 0x65,
	ANIMATION_STATE_FLY = 0x66,
	ANIMATION_STATE_PRONE = 0x67,
	ANIMATION_STATE_PRONE_CRAWL = 0x68,
	ANIMATION_STATE_RAM = 0x69,
	ANIMATION_STATE_CROUCH = 0x6A,
	ANIMATION_STATE_CROUCH_WALK = 0x6B,
	ANIMATION_STATE_CROUCH_WALK_LEFT = 0x6C,
	ANIMATION_STATE_CROUCH_WALK_RIGHT = 0x6D,
	ANIMATION_STATE_CROUCH_WALK_BACK = 0x6E,
	ANIMATION_STATE_CROUCH_READY = 0x6F,
	ANIMATION_STATE_CROUCH_WALK_READY_FWD = 0x70,
	ANIMATION_STATE_CROUCH_WALK_READY_LEFT = 0x71,
	ANIMATION_STATE_CROUCH_WALK_READY_RIGHT = 0x72,
	ANIMATION_STATE_CROUCH_WALK_READY_BACK = 0x73,
	ANIMATION_STATE_CROUCH_AIM = 0x74,
	ANIMATION_STATE_CROUCH_WALK_AIM_FWD = 0x75,
	ANIMATION_STATE_CROUCH_WALK_AIM_LEFT = 0x76,
	ANIMATION_STATE_CROUCH_WALK_AIM_RIGHT = 0x77,
	ANIMATION_STATE_CROUCH_WALK_AIM_BACK = 0x78,
	ANIMATION_STATE_CROUCH_RUN = 0x79,
	ANIMATION_STATE_STAND_DOWNREADY = 0x7A,
	ANIMATION_STATE_WALK_DOWNREADY = 0x7B,
	ANIMATION_STATE_RUN_DOWNREADY = 0x7C,
	ANIMATION_STATE_CROUCH_DOWNREADY = 0x7D,
	ANIMATION_STATE_CROUCH_WALK_DOWNREADY = 0x7E,
	ANIMATION_STATE_CROUCH_RUN_DOWNREADY = 0x7F,
	ANIMATION_STATE_DRIVE_READY = 0x80,
	ANIMATION_STATE_DRIVE_READY_LEFT = 0x81,
	ANIMATION_STATE_DRIVE_READY_RIGHT = 0x82,
	ANIMATION_STATE_DRIVE_LEFT_READY = 0x83,
	ANIMATION_STATE_DRIVE_LEFT_READY_LEFT = 0x84,
	ANIMATION_STATE_DRIVE_LEFT_READY_RIGHT = 0x85,
	ANIMATION_STATE_DRIVE_RIGHT_READY = 0x86,
	ANIMATION_STATE_DRIVE_RIGHT_READY_LEFT = 0x87,
	ANIMATION_STATE_DRIVE_RIGHT_READY_RIGHT = 0x88,
	ANIMATION_STATE_RIDE_READY = 0x89,
	ANIMATION_STATE_RIDE_READY_LEFT = 0x8A,
	ANIMATION_STATE_RIDE_READY_RIGHT = 0x8B,
	ANIMATION_STATE_RIDE_READY_BACK = 0x8C,
	ANIMATION_STATE_RIDE_LEFT_READY = 0x8D,
	ANIMATION_STATE_RIDE_LEFT_READY_LEFT = 0x8E,
	ANIMATION_STATE_RIDE_LEFT_READY_RIGHT = 0x8F,
	ANIMATION_STATE_RIDE_LEFT_READY_BACK = 0x90,
	ANIMATION_STATE_RIDE_RIGHT_READY = 0x91,
	ANIMATION_STATE_RIDE_RIGHT_READY_LEFT = 0x92,
	ANIMATION_STATE_RIDE_RIGHT_READY_RIGHT = 0x93,
	ANIMATION_STATE_RIDE_RIGHT_READY_BACK = 0x94,
	ANIMATION_STATE_CALM_FALL = 0x95,
	ANIMATION_STATE_CALM_FALL_RUN = 0x96,
	ANIMATION_STATE_WORRIED_FALL = 0x97,
	ANIMATION_STATE_WORRIED_FALL_RUN = 0x98,
	ANIMATION_STATE_PANIC_FALL = 0x99,
	ANIMATION_STATE_FALL_FROM_BUILDING = 0x9A,
	ANIMATION_STATE_MELEE_FALL = 0x9B,
	ANIMATION_STATE_STAND_JUMP_START = 0x9C,
	ANIMATION_STATE_RUN_JUMP_START = 0x9D,
	ANIMATION_STATE_MELEE_STAND = 0x9E,
	ANIMATION_STATE_MELEE_WALK = 0x9F,
	ANIMATION_STATE_STAND_BLOCK = 0xA0,
	ANIMATION_STATE_WALK_BLOCK = 0xA1,
	ANIMATION_STATE_COMBAT_STAND = 0xA2,
	ANIMATION_STATE_BODY_READY = 0xA3,
	ANIMATION_STATE_BK_LIEDOWN = 0xA4,
	ANIMATION_STATE_AIM_UP = 0xA5,
	ANIMATION_STATE_AIM_DOWN = 0xA6,
	ANIMATION_STATE_ROTATE_LEFT = 0xA7,
	ANIMATION_STATE_ROTATE_RIGHT = 0xA8,
	ANIMATION_STATE_FALL_DEAD = 0xA9,
	ANIMATION_STATE_VEHICLE_ENTER_STAND = 0xAA,
	ANIMATION_STATE_VEHICLE_ENTER_STAND_2 = 0xAB,
	ANIMATION_STATE_VEHICLE_ENTER_STAND_3 = 0xAC,
	ANIMATION_STATE_VEHICLE_ENTER_STAND_4 = 0xAD,
	ANIMATION_STATE_VEHICLE_ENTER_STAND_5 = 0xAE,
	ANIMATION_STATE_VEHICLE_ENTER_STAND_6 = 0xAF,
	ANIMATION_STATE_VEHICLE_PASS_STAND_1 = 0xB0,
	ANIMATION_STATE_VEHICLE_PASS_STAND_2 = 0xB1,
	ANIMATION_STATE_VEHICLE_PASS_STAND_3 = 0xB2,
	ANIMATION_STATE_VEHICLE_PASS_STAND_4 = 0xB3,
	ANIMATION_STATE_VEHICLE_PASS_STAND_5 = 0xB4,
	ANIMATION_STATE_VEHICLE_PASS_STAND_6 = 0xB5,
	ANIMATION_STATE_VEHICLE_PASS_SIT_1 = 0xB6,
	ANIMATION_STATE_VEHICLE_PASS_SIT_2 = 0xB7,
	ANIMATION_STATE_VEHICLE_PASS_SIT_3 = 0xB8,
	ANIMATION_STATE_VEHICLE_PASS_SIT_4 = 0xB9,
	ANIMATION_STATE_VEHICLE_PASS_SIT_5 = 0xBA,
	ANIMATION_STATE_VEHICLE_PASS_SIT_6 = 0xBB,
	ANIMATION_STATE_VEHICLE_DIVE_EXIT = 0xBC,
	ANIMATION_STATE_VEHICLE_PRONE = 0xBD,
	ANIMATION_STATE_DRIVING_FORWARD = 0xBE,
	ANIMATION_STATE_DRIVING_REVERSE = 0xBF,
	ANIMATION_STATE_DRIVING_FORWARD_LEFT = 0xC0,
	ANIMATION_STATE_DRIVING_FORWARD_RIGHT = 0xC1,
	ANIMATION_STATE_DRIVING_REVERSE_LEFT = 0xC2,
	ANIMATION_STATE_DRIVING_REVERSE_RIGHT = 0xC3,
	ANIMATION_STATE_RIDING_READY = 0xC4,
	ANIMATION_STATE_RIDING_LEFT_READY = 0xC5,
	ANIMATION_STATE_THROWN_DRIVE_READY = 0xC6,
	ANIMATION_STATE_THROWN_DRIVE_LEFT_READY = 0xC7,
	ANIMATION_STATE_THROWN_DRIVE_RIGHT_READY = 0xC8,
	ANIMATION_STATE_THROWN_RIDE_READY = 0xC9,
	ANIMATION_STATE_VEHICLE_OPEN_DOOR_DRIVER = 0xCA,
	ANIMATION_STATE_VEHICLE_OPEN_DOOR_PASSENGER = 0xCB,
	ANIMATION_STATE_TURRET_STAND = 0xCC,
	ANIMATION_STATE_TURRET_LEFT = 0xCD,
	ANIMATION_STATE_TURRET_SLIGHT_LEFT = 0xCE,
	ANIMATION_STATE_TURRET_MIDDLE = 0xCF,
	ANIMATION_STATE_TURRET_SLIGHT_RIGHT = 0xD0,
	ANIMATION_STATE_TURRET_RIGHT = 0xD1,
	ANIMATION_STATE_LADDER_IDLE_LEFT = 0xD2,
	ANIMATION_STATE_LADDER_IDLE_RIGHT = 0xD3,
	ANIMATION_STATE_LADDER_SLIDE_DOWN = 0xD4,
	ANIMATION_STATE_FINE_AIM = 0xD5,
	ANIMATION_STATE_FINE_AIM_WALK = 0xD6,
	ANIMATION_STATE_FINE_AIM_WALK_LEFT = 0xD7,
	ANIMATION_STATE_FINE_AIM_WALK_RIGHT = 0xD8,
	ANIMATION_STATE_FINE_AIM_WALK_BACK = 0xD9,
	ANIMATION_STATE_FINE_AIM_CROUCH = 0xDA,
	ANIMATION_STATE_FINE_AIM_CROUCH_WALK = 0xDB,
	ANIMATION_STATE_FINE_AIM_CROUCH_WALK_LEFT = 0xDC,
	ANIMATION_STATE_FINE_AIM_CROUCH_WALK_RIGHT = 0xDD,
	ANIMATION_STATE_FINE_AIM_CROUCH_WALK_BACK = 0xDE,
	ANIMATION_STATE_TALK_ON_RADIO = 0xDF,
	ANIMATION_STATE_STAND_LEAN = 0xE0,
	ANIMATION_STATE_BEER_SIT = 0xE1,
	ANIMATION_STATE_BEER_STAND = 0xE2,
	ANIMATION_STATE_BEER_WALK = 0xE3,
	ANIMATION_STATE_BAR_LEAN = 0xE4,
	ANIMATION_STATE_BARTEND_STAND = 0xE5,
	ANIMATION_STATE_BARTEND_CLEAN = 0xE6,
	ANIMATION_STATE_JACKHAMMER_STAND = 0xE7,
	ANIMATION_STATE_SIT_BENCH = 0xE8,
	ANIMATION_STATE_SIT_BENCH_TIRED = 0xE9,
	ANIMATION_STATE_SIT_BENCH_READ = 0xEA,
	ANIMATION_STATE_BRIEFCASE_FLEE = 0xEB,
	ANIMATION_STATE_BRIEFCASE_STAND = 0xEC,
	ANIMATION_STATE_BRIEFCASE_WALK = 0xED,
	ANIMATION_STATE_TIED_UP_KNEEL = 0xEE,
	ANIMATION_STATE_TIED_UP_STAND = 0xEF,
	ANIMATION_STATE_FREE_NPC = 0xF0,
	ANIMATION_STATE_MP_RHINO = 0xF1,
	ANIMATION_STATE_ELECTRIC_SHOCK = 0xF2,
	ANIMATION_STATE_STAND_B = 0xF3,
	ANIMATION_STATE_TALK = 0xF4,
	ANIMATION_STATE_TALK_COLD = 0xF5,
	ANIMATION_STATE_TALK_HAPPY = 0xF6,
	ANIMATION_STATE_TALK_HAPPY_COLD = 0xF7,
	ANIMATION_STATE_TALK_SECRETIVE = 0xF8,
	ANIMATION_STATE_TALK_SECRETIVE_COLD = 0xF9,
	ANIMATION_STATE_OPEN = 0xFA,
	ANIMATION_STATE_CLOSED = 0xFB,
	ANIMATION_STATE_FLYER_GROUNDED = 0xFC,
	ANIMATION_STATE_FACIAL_AFRAID = 0xFD,
	ANIMATION_STATE_FACIAL_ANGRY = 0xFE,
	ANIMATION_STATE_FACIAL_CONCERNED = 0xFF,
	ANIMATION_STATE_FACIAL_DEPRESSED = 0x100,
	ANIMATION_STATE_FACIAL_GRUMBLE = 0x101,
	ANIMATION_STATE_FACIAL_HOPEFUL = 0x102,
	ANIMATION_STATE_FACIAL_HAPPY = 0x103,
	ANIMATION_STATE_FACIAL_HAPPY_A = 0x104,
	ANIMATION_STATE_FACIAL_OPRESSED = 0x105,
	ANIMATION_STATE_FACIAL_WIDE_EYED = 0x106,
	ANIMATION_STATE_FACIAL_YAWN = 0x107,
	ANIMATION_STATE_AMB_STAND_BEAM = 0x108,
	ANIMATION_STATE_AMB_WALK_BEAM = 0x109,
	ANIMATION_STATE_AMB_DRUNK_WALK = 0x10A,
	ANIMATION_STATE_AMB_DRUNK_STAND = 0x10B,
	ANIMATION_STATE_AMB_WARM_HANDS = 0x10C,
	ANIMATION_STATE_AMB_KIOSK_STAND = 0x10D,
	ANIMATION_STATE_AMB_HAMMER_STAND = 0x10E,
	ANIMATION_STATE_AMB_HAMMER_WALK = 0x10F,
	ANIMATION_STATE_AMB_MINING_A = 0x110,
	ANIMATION_STATE_AMB_MINING_B = 0x111,
	ANIMATION_STATE_AMB_MINING_GROUND = 0x112,
	ANIMATION_STATE_AMB_CLIPBOARD_STAND = 0x113,
	ANIMATION_STATE_AMB_CLIPBOARD_WALK = 0x114,
	ANIMATION_STATE_AMB_SHOPPER_BROWSE = 0x115,
	ANIMATION_STATE_AMB_SHOPPER_WALK = 0x116,
	ANIMATION_STATE_AMB_STOREKEEPER_STAND = 0x117,
	ANIMATION_STATE_AMB_SMOKER_STAND = 0x118,
	ANIMATION_STATE_AMB_ROCK_STAND = 0x119,
	ANIMATION_STATE_AMB_ROCK_WALK = 0x11A,
	ANIMATION_STATE_AMB_PRAY = 0x11B,
	ANIMATION_STATE_AMB_PRAY_B = 0x11C,
	ANIMATION_STATE_AMB_PRAY_C = 0x11D,
	ANIMATION_STATE_AMB_CROUCH = 0x11E,
	ANIMATION_STATE_AMB_WARM_HANDS_B = 0x11F,
	ANIMATION_STATE_AMB_BENCHTABLE_SIT = 0x120,
	ANIMATION_STATE_AMB_BENCHTABLE_SIT_B = 0x121,
	ANIMATION_STATE_AMB_SHOPPER_STAND_BAG = 0x122,
	ANIMATION_STATE_AMB_SHOPPER_WALK_BAG = 0x123,
	ANIMATION_STATE_AMB_BOX_STAND = 0x124,
	ANIMATION_STATE_AMB_BOX_WALK = 0x125,
	ANIMATION_STATE_AMB_SLEEP_IN_BED = 0x126,
	ANIMATION_STATE_AMB_MINING_TAKE_READING = 0x127,
	ANIMATION_STATE_AMB_GARDEN_WORK = 0x128,
	ANIMATION_STATE_AMB_HAMMER_WORK = 0x129,
	ANIMATION_STATE_AMB_LEAN = 0x12A,
	ANIMATION_STATE_AMB_LEAN_B = 0x12B,
	ANIMATION_STATE_AMB_LOOK_BINOCULARS = 0x12C,
	ANIMATION_STATE_AMB_STEPS_SIT = 0x12D,
	ANIMATION_STATE_AMB_WELD = 0x12E,
	ANIMATION_STATE_AMB_CROUCH_WELD = 0x12F,
	ANIMATION_STATE_AMB_SWEEP_STAND = 0x130,
	ANIMATION_STATE_AMB_SWEEP_WALK = 0x131,
	ANIMATION_STATE_AMB_TOOLBOX_STAND = 0x132,
	ANIMATION_STATE_AMB_SIT_JAIL = 0x133,
	ANIMATION_STATE_AMB_EXECUTE_STAND = 0x134,
	ANIMATION_STATE_AMB_COWER_CROUCH = 0x135,
	ANIMATION_STATE_AMB_COWER_STAND = 0x136,
	ANIMATION_STATE_AMB_KNEEL = 0x137,
	ANIMATION_STATE_AMB_WORK_STAND = 0x138,
	ANIMATION_STATE_AMB_INJURED_GROUND = 0x139,
	ANIMATION_STATE_AMB_INJURED_IDLE = 0x13A,
	ANIMATION_STATE_CLTR_EXC_INSPECT = 0x13B,
	ANIMATION_STATE_STAND_LOW_CONTROL = 0x13C,
	ANIMATION_STATE_STAND_LOW_CONTROL2 = 0x13D,
	ANIMATION_STATE_SAM_STAND = 0x13E,
	ANIMATION_STATE_SAM_WELD = 0x13F,
	ANIMATION_STATE_RFC_STAND = 0x140,
	ANIMATION_STATE_OLD_COOT_SIT = 0x141,
	NUM_ANIM_STATES = 0x142,
};
...
//Extended version of zone_object meant to make handling them easier when reading directly from binary
struct zone_object_extended
{
	unsigned int classname_hash;
	unsigned int handle;
	vector bmin;
	...
	unsigned short prop_list_size;
	char prop_list; //Variable to make getting address of prop list easier, starts at the address of this var
};
