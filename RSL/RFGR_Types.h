...
class __declspec(align(4)) explosion_info //340 Bytes
{
public:
    explosion_info(const explosion_info& other)
        : m_name{}, m_unique_id(other.m_unique_id),
          m_name_crc_str(other.m_name_crc_str),
          flags(other.flags),
          m_radius(other.m_radius),
          m_secondary_radius(other.m_secondary_radius),
          m_knockdown_radius(other.m_knockdown_radius),
          m_flinch_radius(other.m_flinch_radius),
          m_ai_sound_radius(other.m_ai_sound_radius),
          m_human_min_damage_hitpoints(other.m_human_min_damage_hitpoints),
          m_human_max_damage_hitpoints(other.m_human_max_damage_hitpoints),
          m_vehicle_min_damage_hitpoints(other.m_vehicle_min_damage_hitpoints),
          m_vehicle_max_damage_hitpoints(other.m_vehicle_max_damage_hitpoints),
          player_damage_mult(other.player_damage_mult),
          player_veh_damage_mult(other.player_veh_damage_mult),
          player_vehicle_impulse_mult(other.player_vehicle_impulse_mult),
          m_impulse_magnitude(other.m_impulse_magnitude),
          m_structural_damage(other.m_structural_damage),
          expanding_explosion_duration(other.expanding_explosion_duration),
          expanding_explosion_delay(other.expanding_explosion_delay),
          m_num_effects(other.m_num_effects),
          m_num_material_effects(other.m_num_material_effects),
          salvage_material(other.salvage_material),
          salvage_max_pieces(other.salvage_max_pieces),
          salvage_probability(other.salvage_probability),
          time_between_breaks(other.time_between_breaks),
          half_angle_dot(other.half_angle_dot),
          blast_decal_radius(other.blast_decal_radius), camera_shake_type{},
          camera_shake_multiplier(other.camera_shake_multiplier),
          camera_shake_falloff(other.camera_shake_falloff),
          ignore_orientation(other.ignore_orientation),
          always_ragdoll(other.always_ragdoll)
    {
        //Copy arrays not handled by generated code
        std::copy(std::begin(other.m_name), std::end(other.m_name), std::begin(m_name));
        std::copy(std::begin(other.m_effects), std::end(other.m_effects), std::begin(m_effects));
        std::copy(std::begin(other.m_material_effects), std::end(other.m_material_effects), std::begin(m_material_effects));
        std::copy(std::begin(other.m_material_reference), std::end(other.m_material_reference), std::begin(m_material_reference));
    }

    explosion_info& operator=(const explosion_info& other)
    {
        ...
        time_between_breaks = other.time_between_breaks;
        half_angle_dot = other.half_angle_dot;
        blast_decal_radius = other.blast_decal_radius;
        camera_shake_multiplier = other.camera_shake_multiplier;
        camera_shake_falloff = other.camera_shake_falloff;
        ignore_orientation = other.ignore_orientation;
        always_ragdoll = other.always_ragdoll;
    ...
    explosion_info(): m_name{"Default"}, m_unique_id(0), m_name_crc_str(0), flags(0), m_radius(0), m_secondary_radius(0),
                      m_knockdown_radius(0),
                      m_flinch_radius(0),
                      m_ai_sound_radius(0),
                      m_human_min_damage_hitpoints(0),
                      m_human_max_damage_hitpoints(0),
                      m_vehicle_min_damage_hitpoints(0),
                      m_vehicle_max_damage_hitpoints(0), player_damage_mult(0),
                      player_veh_damage_mult(0),
                      player_vehicle_impulse_mult(0),
                      m_impulse_magnitude(0),
                      m_structural_damage(0),
                      expanding_explosion_duration(0),
                      expanding_explosion_delay(0),
                      m_num_effects(0), m_effects{},
                      m_num_material_effects(0),
                      m_material_effects{},
                      m_material_reference{},
                      salvage_material(),
                      salvage_max_pieces(0),
                      salvage_probability(0),
                      time_between_breaks(0),
                      half_angle_dot(0),
                      blast_decal_radius(0),
                      camera_shake_type{},
                      camera_shake_multiplier(0),
                      camera_shake_falloff(0),
                      ignore_orientation(false),
                      always_ragdoll(false)
    {}
