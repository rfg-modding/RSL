...
void WelcomeGui::Draw()
{
    ...
    ImGui::PopStyleColor();
	Gui::TooltipOnPrevious("This menu displays all the scripts detected in the scripts folder and lets you run, edit, and stop them on command. If the script isn't using event hooks then stopping it does nothing, since it stops after running once.", Globals::FontNormal);
    ...
    ImGui::PopStyleColor();
	Gui::TooltipOnPrevious("The console is useful for quickly setting values or calling functions without writing a script. Anything that scripts have access to, the console does too. The console is just running your input into it as a script.", Globals::FontNormal);
    ...
    ImGui::PopStyleColor();
	Gui::TooltipOnPrevious("The script editor allows you to save, load, edit, and run lua scripts in game, and provides basic lua syntax highlighting.", Globals::FontNormal);
    ...
    ImGui::PopStyleColor();
	Gui::TooltipOnPrevious("This menu has settings for invulnerability, infinite jetpack, player move speed, player jump height, xray vision, and more.", Globals::FontNormal);
    ...
    ImGui::PopStyleColor();
	Gui::TooltipOnPrevious("This menu allows you to teleport around the map. There are many preset locations, and you may create your own. Any of your custom locations are saved in TeleportLocations.json. You don't need to edit it by hand as you can do all the editing you need in the gui.", Globals::FontNormal);
    ...
    ImGui::PopStyleColor();
	Gui::TooltipOnPrevious("Contains several settings for the free camera and and experimental first person camera. Includes settings for clip distance which determines how far away you can see terrain and some shadows from.", Globals::FontNormal);
    ...
    ImGui::PopStyleColor();
    Gui::TooltipOnPrevious("This menu lets you turn on the explosion spawn feature, customize your explosion starting from presets, view explosion and effect presets, and more.", Globals::FontNormal);
	ImGui::PopStyleColor();
	ImGui::PopFont();
...
with the top menu bar above.");
	...
	ImGui::Text("\nUseful shortcuts:");
    Gui::LabelAndValue("Toggle overlay: ", "F1");
    Gui::LabelAndValue("Toggle script editor: ", "F2");
    Gui::LabelAndValue("Toggle lua console: ", "F4 (works any time)");
    Gui::LabelAndValue("Run current script in editor: ", "F5");
    Gui::LabelAndValue("Toggle hud: ", "Numpad 1");
    Gui::LabelAndValue("Toggle fog: ", "Numpad 2");
    Gui::LabelAndValue("Toggle free cam: ", "Numpad 3");
    Gui::LabelAndValue("Lock object in crosshairs to introspection menu: ", "Numpad 4");
    Gui::LabelAndValue("Ragdoll player: ", "Numpad 5");
	ImGui::End();
}